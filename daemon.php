...
$delicious = array('비요뜨' => '삐요뜨', '허니버터아몬드' => '허니버터아몬드', '뚝심햄구이' => '뚝심햄구이', '잉글리쉬머핀' => '잉글리쉬머핀(맥모닝)', '후룻볼' => '후룻볼', '김구이' => '김구이', '크로슈무슈' => '크로슈무슈', '요구르트(MBP)' => 'MBP 요구르트');
...
while(1) {
	...
	switch ($type) {
		case TYPE_BREAKFAST:
			...
			if ($result_final == '' && mb_strpos($food[0][0], '스프') !== false || $result_final == '' && mb_strpos($food[0][0], '죽') !== false) {
